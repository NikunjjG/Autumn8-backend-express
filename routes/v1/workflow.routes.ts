...
import { createCollaborativeSession, createWorkflow, endCollaborativeSession, executeWorkflow, getAllWorkflows, getWorkflowById, saveWorkflow, updateCollaborators } from "../../controllers/workflow.controller.js";
...
workflowRouter.post('/execute/:id', executeWorkflow)
